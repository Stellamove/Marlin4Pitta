...
// PITTA
#if HAS_PITTA_MMU
  #ifndef MF_TIMER_PITTA
    #define MF_TIMER_PITTA     6 // Timer index for Pitta
  #endif
#endif
...
// PITTA
#if HAS_PITTA_MMU
  #define PITTA_TIMER_PRESCALE      36                                        // prescaler for setting pitta timer, 2Mhz
  #define PITTA_TIMER_RATE          (HAL_TIMER_RATE / PITTA_TIMER_PRESCALE)   // frequency of pulse timer
...
// PITTA
#if HAS_PITTA_MMU
#define PITTA_TIMER_DEV TIMER_DEV(MF_TIMER_PITTA)
#endif
