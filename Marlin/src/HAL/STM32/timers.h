...
// PITTA
#if HAS_PITTA_MMU
  #define MF_TIMER_PITTA      2  // Timer Index for PITTA
#endif
...
// PITTA
#if HAS_PITTA_MMU
  #define PITTA_TIMER_RATE 2000000 // 2 Mhz
  extern uint32_t GetPittaTimerClkFreq();
  #define PITTA_TIMER_PRESCALE (GetPittaTimerClkFreq() / (PITTA_TIMER_RATE))
  #define PITTA_TIMER_TICKS_PER_US ((PITTA_TIMER_RATE) / 1000000) // pitta timer ticks per µs
#endif
...
#endif
// PITTA
#ifndef HAL_PITTA_TIMER_ISR
  #define HAL_PITTA_TIMER_ISR() void Pitta_Handler()
#endif
